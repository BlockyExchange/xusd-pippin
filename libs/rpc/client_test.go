...
func TestGetAccountsBalances(t *testing.T) {
	...
	resp, err := MockRpcClient.MakeAccountsBalancesRequest([]string{"xusd_3t6k35gi95xu6tergt6p69ck76ogmitsa8mnijtpxm9fkcm736xtoncuohr3"})
	assert.Nil(t, err)
...
func TestGetAccountBalance(t *testing.T) {
	...
	resp, err := MockRpcClient.MakeAccountBalanceRequest("xusd_3t6k35gi95xu6tergt6p69ck76ogmitsa8mnijtpxm9fkcm736xtoncuohr3")
	assert.Nil(t, err)
...
func TestGetAccountsFrontiers(t *testing.T) {
	...
	resp, err := MockRpcClient.MakeAccountsFrontiersRequest([]string{"xusd_3t6k35gi95xu6tergt6p69ck76ogmitsa8mnijtpxm9fkcm736xtoncuohr3"})
	assert.Nil(t, err)
...
func TestGetAccountsPending(t *testing.T) {
	...
	resp, err := MockRpcClient.MakeAccountsPendingRequest([]string{"xusd_3t6k35gi95xu6tergt6p69ck76ogmitsa8mnijtpxm9fkcm736xtoncuohr3"})
	assert.Nil(t, err)
	blocks := *resp.Blocks
...
func TestMakeBlockInfoRequest(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Equal(t, "xusd_1ipx847tk8o46pwxt5qjdbncjqcbwcc1rrmqnkztrfjy5k7z4imsrata9est", resp.BlockAccount)
	...
	assert.Equal(t, "xusd_1ipx847tk8o46pwxt5qjdbncjqcbwcc1rrmqnkztrfjy5k7z4imsrata9est", resp.Contents.Account)
	assert.Equal(t, "CE898C131AAEE25E05362F247760F8A3ACF34A9796A5AE0D9204E86B0637965E", resp.Contents.Previous)
	assert.Equal(t, "xusd_1stofnrxuz3cai7ze75o174bpm7scwj9jn3nxsn8ntzg784jf1gzn1jjdkou", resp.Contents.Representative)
	...
	assert.Equal(t, "xusd_1qato4k7z3spc8gq1zyd8xeqfbzsoxwo36a45ozbrxcatut7up8ohyardu1z", resp.Contents.LinkAsAccount)
...
func TestMakeAccountInfoRequest(t *testing.T) {
	...
	assert.Equal(t, "xusd_1gyeqc6u5j3oaxbe5qy1hyz3q745a318kh8h9ocnpan7fuxnq85cxqboapu5", resp.Representative)
